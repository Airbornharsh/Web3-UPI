...
const SmallScreenMenu = () => {
  ...
  return (
    <div className="flex items-center gap-2 py-2 pr-4 text-xl sm:hidden">
      ...
      >
        ...
        <div className="flex">
         {user?.name && (
          <span className="text-ellipsis text-sm">Name: {user?.name}</span>
         )}
        </div>
        <div className="flex">
         {user?.upiId && (
          <span className="text-ellipsis text-sm">UpiId: {user?.upiId}</span>
         )}
        </div>
        <div className="flex">
         {publicKey && (
